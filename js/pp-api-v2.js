...
(function (window) {
  ...
  function simulatedResponse(action) {
    ...
    if (action === "pp_v2_book_config") return {ok:true,data:{pageSizes:[20,50,100],defaultPageSize:20,sorts:[{id:"name_asc",label:"Désignation de A à Z"},{id:"name_desc",label:"Désignation de Z à A"},{id:"type_asc",label:"Type puis désignation"},{id:"domain_asc",label:"Domaine de A à Z"},{id:"diploma_asc",label:"Diplôme de A à Z"}],facets:{types:["Équipement","Produit"],families:["Produits chimiques"],regimes:["Autorisé"]},validation:{canViewPending:true,statuses:[{id:"",label:"Fiches validées"},{id:"PENDING_VALIDATION",label:"En cours de validation"}]},diplomaDomainFilters:{enabled:true,domainIdStrategy:"NORMALIZED_LABEL_PROVISIONAL",domains:[{id:"maintenance",label:"Maintenance"}],diplomas:[{id:"DIP-DEMO",label:"Diplôme de démonstration",domains:[{id:"maintenance",label:"Maintenance"}]}]},mediaPolicy:{preferredProvider:"GOOGLE_DRIVE",legacyProviderPresent:false}},error:null,meta:{environment:"DEV",version:"2.0.0-dev.6",simulation:true}};
    if (action === "pp_v2_book_search") return {ok:true,data:{items:[{id:"EQ-DEMO-1",name:"Équipement de démonstration",type:"Équipement",family:"",regime:"Autorisé",regimePresentation:{code:"AUTHORIZED",label:"Autorisé",tone:"success",raw:"Autorisé"},validationStatus:"VALIDATED",domains:"Maintenance",domainReferences:[{id:"maintenance",label:"Maintenance"}],diplomas:[{id:"DIP-DEMO",label:"Diplôme de démonstration",domains:[{id:"maintenance",label:"Maintenance"}]}],thumbnail:{url:"",provider:"NONE",migrationRequired:false,available:false},media:{url:"",provider:"NONE",migrationRequired:false,available:false}}],page:1,pageSize:20,resultStart:1,resultEnd:1,hasPrevious:false,hasNext:false,total:1,activeFilters:{},cacheHit:true,durationMs:2},error:null,meta:{environment:"DEV",version:"2.0.0-dev.6",simulation:true}};
    if (action === "pp_v2_book_get") return {ok:true,data:{id:"EQ-DEMO-1",name:"Équipement de démonstration",type:"Équipement",family:"",regime:"Autorisé",regimePresentation:{code:"AUTHORIZED",label:"Autorisé",tone:"success",raw:"Autorisé"},validationStatus:"VALIDATED",regimeDetails:"Fiche simulée sans donnée réelle.",domains:[{id:"maintenance",label:"Maintenance"}],diplomas:[{id:"DIP-DEMO",label:"Diplôme de démonstration",domains:[{id:"maintenance",label:"Maintenance"}]}],legacyDomains:"",legacyDiplomas:"",regulatedWorks:"Travaux simulés",workNature:"",legalArticles:"",periodicInspection:"",observations:"",chemical:{type:"",family:"",minorsRegime:"",mainAgents:"",clpHazards:"",recommendedPpe:""},media:{url:"",provider:"NONE",migrationRequired:false,available:false},documents:[]},error:null,meta:{environment:"DEV",version:"2.0.0-dev.6",simulation:true}};
